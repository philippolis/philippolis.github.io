(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://philippolis.github.io/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://philippolis.github.io/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://philippolis.github.io/assets/css/just-the-docs-' + theme + ".css"
      );
    };
